...
{
    std::shared_ptr<DHCPServerConfiguration> result = std::make_shared<DNSMasqDHCPServerConfiguration>(this->conf_mutex, dnsmasq_controller, interface_name, ip_range_start, ip_range_end, lease);
    return result;
}
